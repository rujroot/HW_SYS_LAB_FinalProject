...
module ascii_rom(
	...
	always @*
		case(addr_reg)
			...
			11'h5b2: data = 8'b01111110;	//
			11'h5b3: data = 8'b11111111;	//
			11'h5b4: data = 8'b01000011;	//
			11'h5b5: data = 8'b01000011;	//
			11'h5b6: data = 8'b01000111;	//
			11'h5b7: data = 8'b01000011;	//
			11'h5b8: data = 8'b01000011;	//
			11'h5b9: data = 8'b01000011;	//
			11'h5ba: data = 8'b01000011;	//
			11'h5bb: data = 8'b01100011;	//
